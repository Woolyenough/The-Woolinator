...
class ErrorHandler(commands.Cog):
    ...
    async def on_command_error(self, ctx: Context, error: commands.CommandError):
        ...
        if isinstance(error, commands.UserInputError):
            ...
            # A Member|User union failure is unwrapped to its underlying not-found
            # error, which then flows into the BadArgument handling below.
            ...
            if isinstance(error, commands.MissingRequiredArgument):
                ...
                # errors ignored: BadColourArgument, BadInviteArgument, EmojiNotFound, GuildStickerNotFound, ScheduledEventNotFound, PartialEmojiConversionFailure
        ...
        # Unwrap CommandInvokeError (& similar) to get the underlying exception
